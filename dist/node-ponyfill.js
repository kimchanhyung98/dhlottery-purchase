...
function Body(body) {
	...
	} else if (body instanceof require$$0$2) ; else {
		// none of the above
	...
	if (body instanceof require$$0$2) {
...
function clone(instance) {
	...
	if (body instanceof require$$0$2 && typeof body.getBoundary !== 'function') {
		// tee instance body
		p1 = new PassThrough();
		p2 = new PassThrough();
		body.pipe(p1);
...
function extractContentType(body) {
	...
	} else if (body instanceof require$$0$2) {
		// body is stream
...
const STATUS_CODES = require$$0$3.STATUS_CODES;
...
const streamDestructionSupported = 'destroy' in require$$0$2.Readable.prototype;
...
function getNodeRequestOptions(request) {
	...
	if (request.signal && request.body instanceof require$$0$2.Readable && !streamDestructionSupported) {
...
function fetch(url, opts) {
	...
	return new fetch.Promise(function (resolve, reject) {
		...
		const send = (options.protocol === 'https:' ? require$$1$1 : require$$0$3).request;
		...
		const abort = function abort() {
			...
			reject(error);
			if (request.body && request.body instanceof require$$0$2.Readable) {
...
var require$$0 = /*@__PURE__*/index.getAugmentedNamespace(lib);
